# -*- coding: utf-8 -*-
#
# pytest-stoq documentation build configuration file, created by
...
project = u'pytest-stoq'
copyright = u'2015, Stoq Team'
author = u'Stoq Team'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-stoq Documentation',
     [author], 1)
]
